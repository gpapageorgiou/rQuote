...
To get a quote from a tag different than 'science' change the tag argument. For more information on what types of tags are possible see the \textbf{Details} section of the help page: [`rQuote`](../reference/rQuote.html) 
